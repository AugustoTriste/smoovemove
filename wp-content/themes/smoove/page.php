<?php get_header(); ?>
			...
			<div class="top-section section-1 bg-full parallax-header wow fadeIn hidden-mb" style="background-image: url(<?php echo the_sub_field("header_background_image"); ?>);">
