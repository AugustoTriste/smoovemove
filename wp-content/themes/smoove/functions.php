...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'owl-css', get_template_directory_uri() . '/bower_components/owl/owl-carousel/owl.carousel.css', array(), '1.0', 'all' );
        ...
        wp_register_style( 'wpbs', get_template_directory_uri() . '/library/dist/css/styles.1ea44020.min.css', array(), '1.0', 'all' );
  ...
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'bootstrap', 
     ...
     wp_register_script( 'owl-carousel', 
      get_template_directory_uri() . '/bower_components/owl/owl-carousel/owl.carousel.min.js', 
      array('jquery'), 
      '1.2' );

     wp_register_script( 'wow', 
      get_template_directory_uri() . '/bower_components/wow/dist/wow.min.js', 
      array('jquery'), 
      '1.2' );

     wp_register_script( 'isotope-js', 
      get_template_directory_uri() . '/library/js/isotope.min.js', 
      array('jquery'), 
      '1.2' );

    wp_register_script( 'imagesloaded', 
      get_template_directory_uri() . '/bower_componentes/imagesloaded/imagesloaded.pkgd.min.js', 
      array('jquery'), 
      '1.2' );

    wp_register_script( 'bootstrap-select', 
      get_template_directory_uri() . '/bower_components/bootstrap-select/dist/js/bootstrap-select.min.js', 
      array('jquery'), 
      '1.2' );

    wp_register_script( 'wpbs-js', 
      get_template_directory_uri() . '/library/dist/js/scripts.9b4aa696.min.js',
      array('bootstrap'), 
      '1.2' );
